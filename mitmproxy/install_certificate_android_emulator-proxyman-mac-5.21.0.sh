...
#
# install_certificate_android_emulator.sh
# ProxymanCore
#
# Version: v2: 
# - Install certificate to android emulator/device
# - New arguments:
#   - --include-physical: Include physical devices
#
# Created by Proxyman LLC on 10/13/20.
# Copyright © 2025 Proxyman LLC. All rights reserved.
#
# For support, please contact: support@proxyman.com
#
...
print_usage() {
    ...
    echo "  -c, --cert <path_to_cert.pem>  : Path to Proxyman certificate (required for all, certificate)"
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  $0 -m all -i 127.0.0.1 -p 9090 -c proxyman-ca.pem"
    echo "  $0 -m proxy -i 192.168.1.100 -p 9090 --include-physical"
    echo "  $0 -m revertProxy"
    echo "  $0 -m certificate -i 127.0.0.1 -p 9090 -c proxyman-ca.pem"
...
if [[ "$mode" == "all" ]] || [[ "$mode" == "certificate" ]]; then
    if [[ -z "$proxymanCert" ]]; then
        echo "❌ Error: Certificate Path (-c or --cert) is required for mode '$mode'."
        print_usage
        exit 1
    elif [[ ! -f "$proxymanCert" ]]; then
         echo "❌ Error: Certificate file not found at '$proxymanCert'."
         exit 1
    fi
fi
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📱 Install Proxyman Certificate to Android Emulator/Device Script"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo ""
echo "📚 Documentation:"
echo "   https://docs.proxyman.com/debug-devices/android-device/automatic-script-for-android-emulator"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "⚙️  Settings:"
echo "   Mode                : $mode"
...
if [[ -n "$proxymanCert" ]]; then echo "   Certificate Path    : $proxymanCert"; fi
...
checkADBCommand() {
    ...
    then
        ...
        echo ""
        echo "📚 Documentation:"
        echo "   https://docs.proxyman.io/debug-devices/android-device/automatic-script-for-android-emulator#4-how-does-it-work"
        echo ""
...
__inject_root_certificate() {
    echo "3. Installing Proxyman Certificate to System-Level CA..."
